...
@dp.message_handler(user_role=UserRole.ADMIN, text=text[config.bot.default_lang].button.admin.reply.delete_promocode)
@dp.message_handler(user_role=UserRole.ADMIN, text=text[config.bot.second_lang].button.admin.reply.delete_promocode)
