...
@dp.message_handler(text=text[config.bot.default_lang].button.admin.reply.menu_promocodes)
@dp.message_handler(text=text[config.bot.second_lang].button.admin.reply.menu_promocodes)
